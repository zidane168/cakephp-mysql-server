        ...
        <div class="col-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title"> <?= __d('product', 'add_product'); ?> </h3>
                </div>
                        ...
                        <div class="from-group">
                            ...
                            <div class="row">
                                <?php foreach ($labels as $key => $value) { ?>
                                    <div class="col-2">
                                        <?php echo "<input type='checkbox' name='ProductsLabels[]' value='$key'>$value</input>"; ?>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
                        ...
                        <div class="from-group">
                            ...
                            <div class="row">
                                <?php foreach ($plugins as $key => $value) { ?>
                                    <div class="col-2">
                                        <?php echo "<input type='checkbox' name='ProductsPlugins[]' value='$key'>$value</input>"; ?>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
