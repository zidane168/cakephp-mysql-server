 ...
 * @var \App\Model\Entity\AnalystReportCategory $analystReportCategory
 */
?>
                ...
                <div class="box-header d-flex">
                    ...
                    ?>
                        ...
                        <div class="box-tools ml-auto p-1">
                            <?php echo $this->Html->link('<i class="fa fa-pencil"></i> ' . __('edit'), array('action' => 'edit', $analystReportCategory->id), array('class' => 'btn btn-primary', 'escape' => false)); ?>
                        </div>
