                    ...
                    <table id="<?php echo str_replace(' ', '', 'Administrator'); ?>" class="table table-hover table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center"><?= $this->Paginator->sort('Administrators.company_id', __d('company', 'company')) ?></th>
                                
                                <th class="text-center"><?= $this->Paginator->sort('Administrators.last_logged_in', __d('company', 'last_logged_in')) ?></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?= $administrator->has('company') && isset($administrator->company->company_languages) ? $this->Html->link(
                                    reset($administrator->company->company_languages)['name'], ['controller' => 'Companies', 'action' => 'view', $administrator->company->id]) : '' ?></td>
                             
                                
                                <td class="text-center"><?= h($administrator->last_logged_in) ?></td>
                                <td class="text-center">
                                    <?= $this->element('view_check_ico',array('_check' => $administrator->enabled)) ?>
                                </td>

                                <td class="text-center"><?= h($administrator->created) ?></td>            
                                <td class="text-center"><?= h($administrator->modified) ?></td>                                        
                                <td class="text-center">
                                    ...
                                    if (isset($permissions['Administrators']['delete']) && ($permissions['Administrators']['delete'] == true)) { 
                                        ...
                                        echo $this->Form->postLink(  
                                            '<i class="far fa-trash-alt"></i>',  array('action' => 'delete',  $administrator->id), 
                                            array(
