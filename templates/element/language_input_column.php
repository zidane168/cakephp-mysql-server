				...
				if (isset($languages_edit_data[$language['alias']])) {	
					...
					foreach ($language_input_fields as $field)  {
						...
						if (isset($arr_title[$field])) {
							if ($field == "name" || $field == "title" || $field == "description" || $field == "author" || $field == "content") {
								$attr['required'] = 'true';
								$attr['escape'] = true; 
								$attr['label'] = "<font class='red'> * </font>" . $arr_title[$field];
					...
					foreach ($language_input_fields as $field)  {
						...
						if (isset($arr_title[$field])) {
							if ($field == "title" || $field == "description" || $field == "name" || $field == "author" || $field == "content") {
								$attr['required'] = 'true';
								$attr['escape'] = true; 
								$attr['label'] = "<font class='red'> * </font>" . $arr_title[$field];
