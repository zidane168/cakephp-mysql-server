...
// just for deploy only, dev must close this bin/cake bake <--nothing happen
...
use App\Event\CourseListener;
use App\Event\CommonListener;
use Cake\Event\EventManager;

// init Event Listener (write log, send mail ...)
$courseListener = new CourseListener();
EventManager::instance()->on($courseListener);

$commonListener = new CommonListener();
EventManager::instance()->on($commonListener);
