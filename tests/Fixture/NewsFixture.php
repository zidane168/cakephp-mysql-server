...
class NewsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'news_category_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'is_hot_news' => ['type' => 'tinyinteger', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'is_hot_news' => 1,
                'enabled' => 1,
                'created' => '2022-05-25 11:06:18',
                'created_by' => 1,
                'modified' => '2022-05-25 11:06:18',
                'modified_by' => 1,
            ],
        ];
        parent::init();
