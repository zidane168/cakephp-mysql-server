...
/**
 * ChildCategoriesFixture
 */
class ChildCategoriesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'slug' => ['type' => 'string', 'length' => 191, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'category_id' => 1,
                'enabled' => 1,
                'created' => '2021-05-27 16:02:30',
                'created_by' => 1,
                'modified' => '2021-05-27 16:02:30',
                'modified_by' => 1,
            ],
        ];
        parent::init();
