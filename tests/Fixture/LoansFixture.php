...
class LoansFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'name' => 1,
                'enabled' => 1,
                'modified' => '2022-01-19 18:21:30',
                'modified_by' => 1,
                'created' => '2022-01-19 18:21:30',
                'created_by' => 1,
            ],
        ];
        parent::init();
