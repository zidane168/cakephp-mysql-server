...
class RolesPermissionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'permission_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'role_id' => 1,
                'permission_id' => 1,
                'updated' => '2021-05-03 17:44:16',
                'updated_by' => 1,
                'created' => '2021-05-03 17:44:16',
                'created_by' => 1,
            ],
        ];
        parent::init();
